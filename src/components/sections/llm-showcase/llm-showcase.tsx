  ...
  return (
    <section id="companies">
      <div className="container mx-auto">
        ...
        <p className="text-gray-400 text-center">And that&apos;s just the tip of the iceberg.</p>
            ...
            <CarouselContent className="select-none">
              {MODELS.map((model) => (
                <CarouselItem
                  ...
                  <Card key={model.name} className="rounded-xl p-6 flex flex-col min-h-[400px]">
                    ...
                    <div className="text-sm font-medium text-gray-400">{model.provider}</div>
                    ...
                    <div className="w-full mt-6 font-medium">{model.oneliner}</div>
                    <ul className="w-full mt-2 space-y-2">
                      {(model.description.match(/[^.]+\./g) || []).map((sentence, idx) => (
