    ...
    <section id="companies" className="pt-14">
      <div className="container mx-auto">
        ...
        <div className="relative">
          ...
          <div className="pointer-events-none absolute inset-y-0 left-0 h-full w-1/3 bg-gradient-to-r to-transparent from-black"></div>
          <div className="pointer-events-none absolute inset-y-0 right-0 h-full w-1/3 bg-gradient-to-l to-transparent from-black"></div>
        </div>
      </div>
    </section>
  )
